...
public class HorizontalBounceScrollView extends HorizontalScrollView{
    ...
    public HorizontalBounceScrollView(Context context, AttributeSet attrs, int defStyle) 
    {
    ...
    { 
       ...
       return super.overScrollBy(deltaX, deltaY, scrollX, scrollY, scrollRangeX, scrollRangeY, mMaxYOverscrollDistance, maxOverScrollY, true);  
    }
   // oversc
